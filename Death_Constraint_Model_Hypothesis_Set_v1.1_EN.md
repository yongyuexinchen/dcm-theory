...
**Version:** v1.1 (companion to EGS Theory Testable Hypothesis Set v1.2)
...
> - The two closest existing constructs added to competing explanations with explicit incremental distinctions: (1) sour grapes / preemptive devaluation (Elster, 1983) — cognitive reappraisal of the object's value, vs. quenching's motivational withdrawal of desire itself; (2) goal disengagement (Carver & Scheier, 1998) — rational resource reallocation at low expectancy, vs. quenching's defensive withdrawal before failure
> - Origin note literature list updated to include Elster (1983) and Carver & Scheier (1998) — the closest constructs, previously omitted
> - Falsification strengthened: quenching must show incremental desire-intensity change beyond object-value reappraisal (sour grapes) and beyond rational disengagement
...
- **P-A1:** Mortality salience (vs. control) increases normative compliance behavior (expected d ≈ 0.2–0.4, consistent with typical TMT effect sizes)
- **P-A2:** The MS → compliance effect is moderated by perceived social enforcement: stronger among individuals who believe norms are socially enforced
- **P-A3:** P-A1–P-A2 hold when controlling for social desirability bias and dispositional conformity (e.g., need for closure)

**Competing explanations to rule out:**
- TMT attitude defense alone (no behavioral increment) — ruled out by including both attitude and behavioral DVs
- Social desirability / demand characteristics — ruled out via control measures and behavioral (not self-report) DVs
- Generalized anxiety priming (not death-specific) — ruled out via aversive control condition (dental pain standard)

**Falsification conditions:**
- H-A is wrong if: (1) MS does not increase normative compliance in a preregistered replication; (2) the effect is fully accounted for by attitude defense (no incremental behavioral variance); (3) the moderation by perceived enforcement fails.

**Study design suggestion:** 2 (MS vs. control) × measured perceived enforcement, N ≥ 200/cell. Preregistered. Single country first (China — high social enforcement context) then cross-cultural comparison (US).
...
**Origin note (honest):** This hypothesis originates from the author's personal experience (n=1) — a long-anticipated relationship goal that extinguished upon approach to realization. The author then found convergent support in existing literature (reference point effects, defensive pessimism, Zeigarnik effect, and — most closely — sour grapes/preemptive devaluation, Elster 1983; goal disengagement, Carver & Scheier 1998; see competing explanations) and generalized it. It is offered as a falsifiable proposal, explicitly acknowledging its origin.

**Incremental claim vs. sour grapes (explicit boundary, added 2026-08-22 per reviewer note):** H-B is NOT sour-grapes reappraisal. *Sour grapes* (Elster 1983) = the object is re-evaluated downward ("it wasn't worth wanting") — a change in **object evaluation**. *H-B* = the desire itself extinguishes *preemptively*, before failure or disappointment arrives — a change in **desire intensity**, while the object may remain valued ("I still know it's good; I just no longer want it"). Falsification condition (4) already treats sour-grapes reappraisal as a competing explanation; this note makes the boundary explicit. **Empirical marker:** H-B predicts desire-intensity decline WITHOUT object-devaluation change; sour grapes predicts the reverse pattern. The scale must therefore measure "want" and "evaluate" as separate items (aligned with the EGS P1.4 discriminant-validity design).

**Proposed mechanism (five components):**
1. **Imagination > reality:** Prolonged anticipation builds imagined versions of the object that exceed any actual version (cognitive simulation research)
2. **Reference point at maximum:** Anticipation pushes the reference point (Kahneman & Tversky, 1979) to the imagined optimum; any real outcome is experienced as a relative *loss* against the reference point
3. **Anticipatory consumption:** Fantasy partially pre-consumes the desired experience, reducing marginal utility of the real event
4. **Meaning vacuum upon completion:** After years of "the goal" being the only horizon, its achievement leaves no next goal (Zeigarnik-tension extension) — completion = loss of structure
5. **Defensive withdrawal (DCM's addition):** The person preemptively withdraws before step 2-4 can occur — protecting the self-narrative "I could have had it" over the reality "I had it and it disappointed"
...
**Testable predictions:**
- **P-B1:** Anticipation intensity positively predicts withdrawal tendency at the approach of realization (controlling for trait neuroticism and general approach-avoidance)
- **P-B2:** The reference point gap mediates the anticipation → withdrawal relationship
- **P-B3:** Withdrawal is stronger for *identity-defining* desires (goals tied to self-worth) than for instrumental desires
- **P-B4:** Among those who do pursue and achieve, satisfaction is negatively predicted by pre-achievement anticipation intensity (imagination > reality)

**Competing explanations to rule out:**
- Defensive pessimism (Norem & Cantor, 1986): lowered expectations to protect against failure — overlapping but distinct: quenching is withdrawal *of desire itself*, not mere expectation adjustment; distinguish by measuring desire intensity change, not just expectation
- Self-handicapping (Berglas & Jones, 1978): creates excuses *after* pursuing; quenching withdraws *before* pursuing — distinguish by timing
- Sour grapes / preemptive devaluation (Elster, 1983): the classic "the grapes are sour anyway" — individuals devalue an unattainable object to reduce dissonance. Overlapping but distinct: sour grapes is a *cognitive reappraisal of the object's value* ("it's not worth wanting"); quenching is a *motivational withdrawal of desire itself* ("I no longer want it"). Distinguish by measuring (a) object evaluation change (sour grapes) vs. desire intensity change (quenching); (b) approach sensitivity — quenching is predicted to intensify as the object approaches realization; sour grapes is not
- Goal disengagement (Carver & Scheier, 1998): the self-regulatory process of withdrawing effort from an unattainable goal and reallocating resources. Overlapping but distinct: disengagement is *rational goal management* at low expectancy (typically followed by calm re-investment in alternative goals); quenching is *defensive withdrawal before failure* (followed by meaning vacuum / avoidance of similar objects). Distinguish by measuring the post-withdrawal state: calm reorientation vs. defensive avoidance
- Anticipated regret (Bell, 1982): deciding against to avoid future regret — control via regret measures
- Burnout/fatigue: prolonged wanting exhausts — control via goal fatigue measures

**Falsification conditions:**
- H-B is wrong if: (1) P-B1 fails in a preregistered study; (2) the withdrawal is fully explained by defensive pessimism or self-handicapping (no incremental desire-intensity change); (3) reference point gap does not mediate; (4) the withdrawal is fully explained by sour-grapes reappraisal (object evaluation change) or rational goal disengagement — i.e., no incremental desire-intensity change remains after controlling for both

**Study design suggestion:** Study B1 (correlational): retrospective survey of goal pursuit episodes (N ≥ 300), measuring anticipation, gap, withdrawal, outcome satisfaction. Study B2 (prospective): track a real approaching goal (e.g., exam candidates, couples nearing marriage, career transitions) over 3-6 months; measure desire intensity trajectory and withdrawal. B2 is the decisive test.
...
1. H-A fails (mortality salience does not increase normative compliance beyond attitude defense)
2. H-B fails (desire does not quench preemptively; withdrawal fully explained by existing constructs)
3. Both H-A and H-B replicate but the EGS link fails (compliance/quenching uncorrelated with perceived fulfillment) — the unified chain is unsupported

**Known limitations (author's explicit acknowledgment):**
- H-B originates from n=1 observation, subsequently grounded in literature; requires independent replication before strong claims
- Both hypotheses need scale development and psychometric validation
- Cross-cultural generalization (China vs. US/West) is hypothesized but untested; collectivist vs. individualist contexts may shift effect magnitudes
- The model does not yet specify individual-difference moderators (age, gender, attachment style) — future work
...
|--------|------|--------------|
| Deleuze, G., & Guattari, F. (1972). *Anti-Oedipus*. | Book | ISBN 978-0143105824 |
| Deleuze, G., & Guattari, F. (1980). *A Thousand Plateaus*. | Book | ISBN 978-0816614028 |
| Greenberg, J., Pyszczynski, T., & Solomon, S. (1986). The causes and consequences of a need for self-esteem. In R. F. Baumeister (Ed.), *Public Self and Private Self* (pp. 189-212). Springer. | Book chapter | DOI: 10.1007/978-1-4613-9564-5_10 |
| Rosenblatt, A., Greenberg, J., Solomon, S., Pyszczynski, T., & Lyon, D. (1989). Evidence for terror management theory I. *JPSP, 57*(4), 681-690. | Journal article | DOI: 10.1037/0022-3514.57.4.681 |
| Kahneman, D., & Tversky, A. (1979). Prospect theory. *Econometrica, 47*(2), 263-291. | Journal article | DOI: 10.2307/1914185 |
| Elster, J. (1983). *Sour Grapes: Studies in the Subversion of Rationality*. Cambridge University Press. | Book | ISBN 978-0521252364 |
| Carver, C. S., & Scheier, M. F. (1998). *On the Self-Regulation of Behavior*. Cambridge University Press. | Book | ISBN 978-0521000996 |
| Norem, J. K., & Cantor, N. (1986). Defensive pessimism. *Journal of Personality and Social Psychology, 51*(6), 1208-1217. | Journal article | DOI: 10.1037/0022-3514.51.6.1208 |
| Berglas, S., & Jones, E. E. (1978). Drug choice as a self-handicapping strategy. *Journal of Personality and Social Psychology, 36*(4), 405-417. | Journal article | DOI: 10.1037/0022-3514.36.4.405 |
| Yong Yue (2026). Death philosophy series + EGS series (Zhihu, Chinese). | Public articles | zhuanlan.zhihu.com |

---

*This document v1.1 | 2026-08-22 | Author: Yong Yue*
*Preprint: https://osf.io/preprints/psyarxiv/4udx9_v1*
*Companion: EGS Theory Testable Hypothesis Set v1.2 (https://osf.io/preprints/psyarxiv/enyvd_v1)*
